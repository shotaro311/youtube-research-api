...
import { buildAiExtractSheetRows, buildCommentDbRows, buildCommentSheetRows, buildScriptDbRows } from "../src/server/google-sheets";
...
describe("buildCommentSheetRows", () => {
  it("creates one row per comment for the human-readable comment sheet", () => {
    const items: ExtractVideoResponse[] = [
      {
        rawData: {
          videoId: "abc123",
